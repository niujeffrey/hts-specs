...
\item[\acs{BED}$n$+:]
  A~\textbf{file} that has the first $n$~\textbf{\acs{BED} field}s, followed by any number of~\textbf{custom field}s.
...
\begin{itemize}[noitemsep]
    \item Which of the first~4 to 12~\textbf{fields} are standard \textbf{\acs{BED} field}s and which are \textbf{custom field}s.
